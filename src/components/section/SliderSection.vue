...
.slider__img {
  background: url(../../assets/img/sliderType/slider_bg01.jpg) no-repeat center / cover;
}
...
.slider__arrow a {
  ...
  width: 30px;
  height: 56px;
  background-image: url(../../assets/img/sliderType/slider_icon.svg);
}
...
.swiper-pagination-bullet {
  ...
  background-image: url(../../assets/img/sliderType/slider_icon.svg) !important;
